...
const generateSlideItem = ({ brandLogo, brandColor, quote, author }) => {
  ...
  newSlide.innerHTML = ` <div class="card-customer">
                    <blockquote>
                      <!-- Brand -->
                      <div class="brand-logo" style="color: ${brandColor}">
                        <!-- Logo -->
                        ${brandLogo}
                      </div>
                      <!-- / .row -->
                      ...
                      <div class="blockquote-footer">
                        <span class="h6 text-uppercase">${author}</span>
                      </div>
                    </blockquote>
                  </div>`;
  return newSlide;
...
const makeSlide = (
  ...
  //set width of the slide-item-wrapper
  ...
  items.forEach((item, i) => {
    ...
    newSlide.style.width = `${offsetX * 100}%`;
  ...
  const updateDotImage = () => {
    let imagesEl = imagesWrapper.childNodes;
